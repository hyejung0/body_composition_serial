...
(from T1, T2,..., to Sacrummid as shown in @fig-spinal_cord), using the
DAFS's automated imaging analysis. Specifically, our analysis focus on
the four *types* of body compositions: intramuscular adipose tissuse,
subcutaneous adipose tissue, visceral adipose tissue, and skeletal
muscle. @fig-CT_scan_types shows CT scan of one cross section for these
four types.
...
confusion. [We decided to add these four composite body compositions in
our study because we believed that total volume of each type of body
compositions would be more strongly associated with survival than just a
single section of spinal cord. (check with Adriana. Is this
